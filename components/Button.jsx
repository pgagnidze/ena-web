...
const styles = {
  primary:
    'rounded-md bg-nord14-100 py-2 px-4 text-sm font-semibold text-white hover:bg-nord14-200 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-300/50 active:bg-nord14-300',
  secondary:
