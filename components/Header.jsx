...
function MobileNavigation(props) {
  return (
    <Popover {...props}>
      <Popover.Button className="group flex items-center rounded-md bg-white/90 px-4 py-2 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur">
        ნავიგაცია
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-md bg-white/90 px-3 text-base font-medium text-zinc-500/90 shadow-lg shadow-zinc-700/5 ring-1 ring-zinc-800/5 backdrop-blur">
        ...
        <NavItem href="https://doc.ena-lang.org" target="_blank">
          დოკუმენტაცია
        </NavItem>
      </ul>
    </nav>
